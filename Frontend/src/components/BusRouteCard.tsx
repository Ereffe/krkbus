        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
            ...
            <span className="text-sm">
              {hasFrequency ? route.frequency : t("app.routeCard.noData")}
            </span>
          </div>
          ...
          <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300 pt-2 border-t dark:border-slate-700">
            ...
            <span className="text-sm">{route.stops.length} {t("app.routeCard.stops")}</span>
          </div>
